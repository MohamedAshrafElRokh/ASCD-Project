        ...
        >
            ...
            <g className="level-g-borders">
                ...
                <g className="level-g-walls">
                    ...
                    <polyline className="map__walls" points="279.48 59.43 279.48 13.77 313.88 13.77 313.88 59.43 293.42 59.43" />
                    <polyline className="map__walls" points="341.16 59.43 316.55 59.43 316.55 13.77 352.13 13.77 352.13 59.43" />
                    <polyline className="map__walls" points="354.5 59.43 354.5 13.77 390.98 13.77 390.98 59.43 367.25 59.43" />
                    <polyline className="map__walls" points="316.55 128.82 316.55 62.4 390.98 62.4 390.98 140.39 316.55 140.39" />
                    ...
                    <polyline className="map__walls" points="502.48 32.45 511.07 32.45 511.07 13.77 393.05 13.77 393.05 32.45 395.13 32.45" />
                    ...
                    <polyline className="map__walls" points="525.6 54.99 553.18 54.99 553.18 13.77 513.45 13.77 513.45 54.99 514.93 54.99" />
                    <polyline
                    ...
                    />
                    <polyline className="map__walls" points="536.58 131.49 536.58 115.48 594.1 115.48 594.1 150.47 536.58 150.47 536.58 140.38" />
                    <polyline className="map__walls" points="524.12 150.47 535.09 150.47 535.09 140.38" />
                    <polyline className="map__walls" points="535.09 131.49 535.09 113.71 552.29 113.7 552.29 71.3 555.85 71.3" />
                    ...
                    <polyline className="map__walls" points="515.23 56.47 513.45 56.47 513.45 57.66 513.45 150.47 515.23 150.47" />
                    ...
                    <polyline className="map__walls" points="300.14 234.19 278.39 234.19 278.39 282.23 208.02 282.23 208.02 274.32" />
                    ...
                    <polyline className="map__walls" points="538.15 159.86 538.15 152.35 583.43 152.35 583.43 199.79 538.15 199.79 538.15 169.74" />
                    <polyline className="map__walls" points="544.48 256.93 538.15 256.93 538.15 204.29 583.43 204.29 582.64 258.11 572.36 258.11" />
                    ...
                    <polyline className="map__walls" points="592.91 249.61 587.18 249.61 587.18 258.11 584.81 258.11 584.81 261.27" />
                    ...
                    />
                    <polyline className="map__walls" points="627.91 358.14 624.15 358.14 624.15 272.34 617.03 272.34 617.03 282.03 611.7 282.03" />
                    <polyline className="map__walls" points="688.79 373.76 688.79 345.09 642.73 345.09 641.74 371.19 642.93 373.76" />
                    <polyline className="map__walls" points="688.79 385.42 647.87 385.42 646.88 382.85" />
                    <polyline className="map__walls" points="690.57 385.42 728.53 385.42 728.53 345.09 690.57 345.09 690.57 373.76" />
                    <polyline
                        className="map__walls"
                    ...
                    />
                    <polyline className="map__walls" points="694.73 390.96 694.73 389.38 738.42 389.38 738.42 409.34 694.73 409.34 694.73 399.36" />
                    <polyline
                        className="map__walls"
                    ...
                    />
                    <polyline className="map__walls" points="642.93 456.98 728.13 456.98 728.13 596.75 623.95 596.75 623.95 456.98 627.12 456.98" />
                    <polyline
                        className="map__walls"
                    ...
                    />
                    <polyline className="map__walls" points="165.12 457.08 168.68 457.08 168.68 597.94 61.73 597.94 61.53 457.08 154.64 457.08" />
                    <polyline className="map__walls" points="107.59 479.52 107.59 458.57 63.11 458.57 63.11 490.2 107.59 490.2" />
                    <polyline className="map__walls" points="107.59 525.78 63.11 525.78 63.11 491.98 107.59 491.98 107.59 515.3" />
                    <polyline className="map__walls" points="107.59 550.88 107.59 527.51 63.11 527.51 63.11 561.37 107.59 561.37" />
                    <polyline className="map__walls" points="107.59 585.68 107.59 562.94 63.11 562.94 63.11 596.55 107.59 596.55 107.59 594.98" />
                    <polyline className="map__walls" points="123.6 572.83 123.6 596.55 167.1 596.55 167.1 562.94 123.6 562.94" />
                    <polyline
                        className="map__walls"
                        points="155.83 486.24 137.25 486.24 123.61 499.49 123.61 561.36 167.09 561.36 167.09 486.24 164.92 486.24"
                    />
                    <polyline className="map__walls" points="95.53 384.04 95.53 385.42 62.71 385.42 62.71 317.02 95.53 317.02 95.53 373.56" />
                    ...
                    <polyline className="map__walls" points="97.31 372.97 97.31 369.21 166.9 369.21 166.9 385.42 164.92 385.42" />
                    ...
                    <polyline className="map__walls" points="260.4 207.7 255.46 207.7 255.46 151.55 279.58 151.55 279.58 206.81 270.68 206.81" />
                    <polyline className="map__walls" points="300.14 236.26 280.96 236.26 280.96 282.23 380.8 282.23 380.8 236.26 310.81 236.26" />
                    ...
                    />
                    <polyline className="map__walls" points="236.68 334.41 259.02 334.41 259.02 288.55 224.82 288.55 224.82 334.41 227.19 334.41" />
                    <polyline className="map__walls" points="283.73 334.41 260.4 334.41 260.4 288.55 294.6 288.55 294.6 334.41 292.63 334.41" />
                    <polyline className="map__walls" points="307.25 334.41 346 334.41 346 288.55 296.19 288.55 296.19 334.41" />
                    <polyline className="map__walls" points="219.04 348.65 227.98 348.65 240.73 361.4 240.73 380.87 208.81 380.87 208.02 304.76" />
                    <polyline className="map__walls" points="208.02 294.09 208.02 288.55 223.44 288.55 223.44 335.61 227.19 335.61" />
                    ...
                    <polyline className="map__walls" points="313.58 374.55 311.61 374.55 311.61 363.87 300.14 351.03 289.27 351.03" />
                    <polyline className="map__walls" points="279.98 351.03 269.1 351.03 256.85 363.28 256.85 373.56 253.09 373.56" />
                    <polyline className="map__walls" points="243.8 373.56 241.92 373.56 241.92 360.71 228.67 347.47 219.04 347.47" />
                    <polyline
                        className="map__walls"
                    ...
                    <polyline className="map__walls" points="434.77 416.85 485.77 416.85 483.59 419.23 483.39 426.35 512.06 426.35 512.06 386.8" />
                    ...
                    <polyline className="map__walls" points="616.24 386.8 618.42 386.8 618.42 385.42 619.8 385.42 619.8 288.16 611.69 288.16" />
                    ...
                    <polyline className="map__walls" points="240.73 385.42 209.4 385.42 209.4 404 204.66 404 204.66 389.57 187.06 389.57" />
            ...
            />
            <rect data-space="1.03" data-room="007A" className="map__space" x="513.05" y="14.19" width="39.73" height="40.81" />
            <rect data-space="1.04" data-room="007B" className="map__space" x="536.18" y="115.56" width="57.53" height="34.99" />
            <rect data-space="1.05" data-room="005A" className="map__space" x="316.15" y="14.19" width="35.58" height="45.67" />
            <rect data-space="1.06" data-room="005B" className="map__space" x="354.11" y="14.19" width="36.47" height="45.67" />
            <polygon
                data-space="1.07"
                data-room="Stacks"
                className="map__space"
            ...
            />
            <rect data-space="1.08" data-room="014" className="map__space" x="624.15" y="456.98" width="103.98" height="139.57" />
            <polygon
                data-space="1.09"
            ...
            />
            <rect data-space="1.12" data-room="009" className="map__space" x="642.88" y="345.09" width="45.92" height="40.33" />
            <rect data-space="1.13" data-room="009A" className="map__space" x="690.57" y="345.09" width="37.96" height="40.33" />
            <rect data-space="1.14" data-room="005" className="map__space" x="316.55" y="62.4" width="74.43" height="77.99" />
            <rect data-space="1.15" data-room="004A" className="map__space" x="243.21" y="14.19" width="33.8" height="45.67" />
            <rect data-space="1.16" data-room="004B" className="map__space" x="279.09" y="14.19" width="34.4" height="45.67" />
            <polygon
                data-space="1.17"
                data-room="004"
                className="map__space"
            ...
            />
            <rect data-space="1.20" data-room="MFLM" className="map__space 030" x="437.51" y="271.35" width="48.27" height="9.53" />
            <polygon
                data-space="1.21"
                data-room="Hall"
                className="map__space"
            ...
            />
            <rect data-space="1.23" data-room="035" className="map__space" x="123.61" y="562.94" width="43.49" height="33.61" />
            <rect data-space="1.24" data-room="039" className="map__space" x="63.11" y="458.57" width="44.48" height="31.63" />
            <rect data-space="1.25" data-room="038" className="map__space" x="63.11" y="491.83" width="44.48" height="33.95" />
            <rect data-space="1.26" data-room="037" className="map__space" x="62.71" y="527.51" width="44.87" height="33.85" />
            <rect data-space="1.27" data-room="036" className="map__space" x="63.11" y="562.94" width="44.48" height="33.61" />
            <path
                className="map__text"
